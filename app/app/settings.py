...
SECRET_KEY = '^m!25susge$6#@lotjd2v1$11zx+3pn40wxcgz%bihjbavi54k'
...
if 'OPENSHIFT_REPO_DIR' in os.environ:
	TEMPLATE_DIR = os.path.join(os.environ.get('OPENSHIFT_DATA_DIR'), 'app', 'votes', 'templates')
else:
	TEMPLATE_DIR = os.path.join(os.environ.get('PROJECT_ROOT'), 'wsgi', 'voting', 'votes', 'templates')
...
CONSTANCE_CONFIG ={
	'VOTE_TIME': (7, 'Time in days for voting'),
}
